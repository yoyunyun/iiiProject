						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="card-body">
										...
										<tr>
											<td>
												<form:form method="POST" action="/Member/updateMemberAPAction.controller" modelAttribute="member" enctype="multipart/form-data">
											...
											<td>
												<form:form method="POST" action="/Member/reUpdateMemberAP" modelAttribute="member" enctype="multipart/form-data">
													<form:hidden path="memberid" value="${member.memberid}" />
													<form:hidden path="verificationCode" value="${member.verificationCode}" />
													<form:hidden path="role" value="${member.role}" />
													<form:hidden path="disabled" value="${member.disabled}" />
