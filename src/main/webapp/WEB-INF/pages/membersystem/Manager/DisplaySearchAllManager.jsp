								...
								<form:form id="updateForm" modelAttribute="manager" enctype="multipart/form-data">
									<table class="table  table-hover">
										...
										<tr>
											...
											<td><form:radiobutton id="male" path="managergender" value="男" label="男" /> 
...
// 		// "新增"按鈕叫出 Modal
// 		$('#gotoInsert').click(function (e) {
// 			e.preventDefault();
// 			$('#insertManagerShow').modal('show');
// 		})		
		...
		function editModal(managerid) {
			...
			let fillWithOrigin = function (res) {
				...
				$("#emaildisplay").html(res.manageremail);
...
// 				deleteModal(e.target.id)});
		...
		function deleteModal(managerid) {
			...
			Swal.fire({
				...
				if (torf.isConfirmed) {
					$.ajax({
						url: "/Manager/deleteManagerAction.controller/" + managerid,
						method: "POST",
						dataType: "json",
						success: function (res) {
							console.log('恭喜您成功刪除');
