...
<div class="sort btn-group-vertical" style="width:210px; line-height:50px; float:left;">
	...
	<a class="btn btn-outline-secondary btn-lg" style="font-size:20px; display: flex; align-items: center;" href="${pageContext.request.contextPath}/comment/drug/commentfront">會員留言</a>
</div>